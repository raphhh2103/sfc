...
$a->setNamespace('sf_orm_default_0ab67e53ecb7eb4f162acd50ac3f6d53c240266d50012dfa5ac82e91d4d9b473');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_0ab67e53ecb7eb4f162acd50ac3f6d53c240266d50012dfa5ac82e91d4d9b473');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_0ab67e53ecb7eb4f162acd50ac3f6d53c240266d50012dfa5ac82e91d4d9b473');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\JobsRepository' => function () {
    return ($this->privates['App\Repository\JobsRepository'] ?? $this->load(__DIR__.'/getJobsRepositoryService.php'));
}, 'App\\Repository\\JobsSfcRepository' => function () {
    return ($this->privates['App\Repository\JobsSfcRepository'] ?? $this->load(__DIR__.'/getJobsSfcRepositoryService.php'));
}, 'App\\Repository\\ResultsRepository' => function () {
    return ($this->privates['App\Repository\ResultsRepository'] ?? $this->load(__DIR__.'/getResultsRepositoryService.php'));
}, 'App\\Repository\\SfcsRepository' => function () {
    return ($this->privates['App\Repository\SfcsRepository'] ?? $this->load(__DIR__.'/getSfcsRepositoryService.php'));
}, 'App\\Repository\\SigningRepository' => function () {
    return ($this->privates['App\Repository\SigningRepository'] ?? $this->load(__DIR__.'/getSigningRepositoryService.php'));
}, 'App\\Repository\\SkillsRepository' => function () {
    return ($this->privates['App\Repository\SkillsRepository'] ?? $this->load(__DIR__.'/getSkillsRepositoryService.php'));
}, 'App\\Repository\\UserJobsRepository' => function () {
    return ($this->privates['App\Repository\UserJobsRepository'] ?? $this->load(__DIR__.'/getUserJobsRepositoryService.php'));
