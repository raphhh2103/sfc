...
// Returns the private 'App\Repository\ResultsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ResultsRepository.php';

return $this->privates['App\Repository\ResultsRepository'] = new \App\Repository\ResultsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
