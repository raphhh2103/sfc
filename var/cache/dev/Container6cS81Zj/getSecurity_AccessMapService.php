...
$a = new \Symfony\Component\HttpFoundation\RequestMatcher('^/former');

$b = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user');
...
$instance->add($b, array(0 => 'ROLE_ADMIN'), NULL);
$instance->add($a, array(0 => 'ROLE_FORMER'), NULL);
$instance->add($b, array(0 => 'ROLE_FORMER'), NULL);
$instance->add($b, array(0 => 'ROLE_USER'), NULL);
