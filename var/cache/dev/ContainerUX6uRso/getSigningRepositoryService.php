...
// Returns the private 'App\Repository\SigningRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SigningRepository.php';

return $this->privates['App\Repository\SigningRepository'] = new \App\Repository\SigningRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
