...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\JobsType' => function () {
    return ($this->privates['App\Form\JobsType'] ?? $this->privates['App\Form\JobsType'] = new \App\Form\JobsType());
}, 'App\\Form\\SFCSType' => function () {
    return ($this->privates['App\Form\SFCSType'] ?? $this->privates['App\Form\SFCSType'] = new \App\Form\SFCSType());
