...
// Returns the private 'App\Repository\JobsSfcRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\JobsSfcRepository.php';

return $this->privates['App\Repository\JobsSfcRepository'] = new \App\Repository\JobsSfcRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
