...
// Returns the private 'App\Repository\SfcsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SfcsRepository.php';

return $this->privates['App\Repository\SfcsRepository'] = new \App\Repository\SfcsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
